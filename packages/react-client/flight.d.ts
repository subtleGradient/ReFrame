...
declare module "react-client/flight" {
  import type {
    ModuleLoading,
  ...
  import type { CallServerCallback, EncodeFormActionCallback } from "react-client/src/ReactFlightReplyClient"
  ...
  type FindSourceMapURLCallback = (fileName: string, environmentName: string) => string | null

  type ReactFlightClient = {
  ...
  export default function ReactFlightClient(config: ReactFlightClientConfig): ReactFlightClient
}

declare module "react-client/src/ReactFlightClientConfig" {
  ...
  type ReactClientManifestRecord = { id: ModuleID; chunks: DependencyChunks; name: ClientModuleExportName }
  ...
  export const resolveClientReference: <T>(
    bundlerConfig: SSRModuleMap,
    metadata: ClientReferenceMetadata,
  ) => ClientReference<T>

  export const resolveServerReference: (bundlerConfig: SSRModuleMap, id: ServerReferenceId) => ClientReference<unknown>

  export const preloadModule: <T>(clientReference: ClientReference<T>) => Promise<void> | null
  export const requireModule: <T>(clientReference: ClientReference<T>) => T
  export const dispatchHint: (code: string, model: unknown) => void
  ...
  export const createStringDecoder: () => StringDecoder
  export const readPartialStringChunk: (decoder: StringDecoder, buffer: Uint8Array) => string
  export const readFinalStringChunk: (decoder: StringDecoder, buffer: Uint8Array) => string

  export const bindToConsole: (
  ...
  export type ReactFlightClientConfig = {
    resolveClientReference: typeof resolveClientReference
    resolveServerReference: typeof resolveServerReference
    preloadModule: typeof preloadModule
    requireModule: typeof requireModule
    dispatchHint: typeof dispatchHint
    prepareDestinationForModule: typeof prepareDestinationForModule
    createStringDecoder: typeof createStringDecoder
    readPartialStringChunk: typeof readPartialStringChunk
    readFinalStringChunk: typeof readFinalStringChunk
    bindToConsole: typeof bindToConsole
    rendererVersion: typeof rendererVersion
    rendererPackageName: typeof rendererPackageName
  }
}
...
declare module "react-client/src/ReactFlightReplyClient" {
  ...
  export type EncodeFormActionCallback = <A>(id: ServerReferenceId, args: Promise<A>) => ReactCustomFormAction
...
declare module "react-client/src/ReactFlightTemporaryReferences" {
