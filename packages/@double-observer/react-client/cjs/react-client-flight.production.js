...
module.exports = function ($$$config) {
    ...
    function resolveToJSON(key, value) {
      ...
      if ("object" === typeof value) {
        ...
        if (void 0 !== parentReference)
          ...
          -1 === key.indexOf(":") &&
            ...
            void 0 !== parentReference &&
              ...
              void 0 !== temporaryReferences && temporaryReferences.set(key, value)))
        ...
        if (key !== ObjectPrototype && (null === key || null !== getPrototypeOf(key))) {
          if (void 0 === temporaryReferences) throw Error(formatProdErrorMessage(499, ""))
          return "$T"
        }
        return value
      }
  ...
  function resolveModule(response, id, model) {
    ...
    prepareDestinationForModule(response._moduleLoading, response._nonce, model)
    ...
    switch (tag) {
      ...
      default:
        ;(tag = response._chunks),
          ...
          : tag.set(id, new ReactPromise("resolved_model", row, null, response))
    }
  }
  ...
  var rendererVersion = $$$config.rendererVersion,
    ...
    REACT_ELEMENT_TYPE =
      React.version.startsWith("19") ? Symbol.for("react.transitional.element") : REACT_LEGACY_ELEMENT_TYPE,
  ...
  $$$config = React.__SERVER_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE
  var ReactSharedInternals = React.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE || $$$config
  ...
  exports.injectIntoDevTools = function () {
    ...
    if ("undefined" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) JSCompiler_inline_result = !1
    else {
      var hook = __REACT_DEVTOOLS_GLOBAL_HOOK__
      if (hook.isDisabled || !hook.supportsFlight) JSCompiler_inline_result = !0
      else {
        try {
    ...
    for (
      ...
      switch (rowState) {
        ...
        case 4:
          ...
          if (rowLength < chunk.length || chunk.length > 3 * rowLength) throw Error(formatProdErrorMessage(540))
