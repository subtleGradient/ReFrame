...
module.exports = function ($$$config) {
  ...
  function renderFunctionComponent(request, task, key, Component, props) {
    ...
    if ("object" === typeof Component && null !== Component && !isClientReference(Component)) {
      ...
      if (iteratorFn) {
        ...
        var iterableChild$9 = Component
        Component = {}
        Component =
          ((Component[ASYNC_ITERATOR] = function () {
            return iterableChild$9[ASYNC_ITERATOR]()
          }),
          Component)
      }
    }
    ...
    if ("function" === typeof value) {
      ...
      if (isServerReference(value))
        return (
          ...
          : ((parentPropertyName = getServerReferenceBoundArguments(request.bundlerConfig, value)),
  ...
  function flushCompletedChunks(request, destination) {
    ...
    0 === request.pendingChunks && ((request.status = 14), close(destination), (request.destination = null))
  }
