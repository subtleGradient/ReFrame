...
"production" !== process.env.NODE_ENV &&
  ((module.exports = function ($$$config) {
    ...
    function switchContext(newSnapshot) {
      ...
      prev !== newSnapshot &&
        (null === prev ? pushAllNext(newSnapshot)
        : null === newSnapshot ? popAllPrevious(prev)
        : prev.depth === newSnapshot.depth ? popToNearestCommonAncestor(prev, newSnapshot)
        : prev.depth > newSnapshot.depth ? popPreviousToCommonLevel(prev, newSnapshot)
    ...
    function warnNoop(publicInstance, callerName) {
      publicInstance =
        ((publicInstance = publicInstance.constructor) && getComponentNameFromType(publicInstance)) || "ReactClass"
        ...
        if (null !== request && "function" === typeof isSignatureEqual) {
          ...
          isSignatureEqual.call(action, request[2], request[3]) &&
            ((nextPostbackStateKey =
              void 0 !== permalink ?
                "p" + permalink
              : "k" + createFastHash(JSON.stringify([componentKeyPath, null, actionStateHookIndex]))),
              ...
              null === nextPostbackStateKey &&
                (nextPostbackStateKey =
                  void 0 !== permalink ?
                    "p" + permalink
                  : "k" + createFastHash(JSON.stringify([componentKeyPath, null, actionStateHookIndex]))),
                JSCompiler_inline_result.append("$ACTION_KEY", nextPostbackStateKey)
            return prefix
          })
    ...
    function describeNativeComponentFrame(fn, construct) {
      ...
      sampleLines =
        (sampleLines = fn ? fn.displayName || fn.name : "") ? describeBuiltInComponentFrame(sampleLines) : ""
    ...
    function resumeRequest(
      ...
      if ("number" === typeof postponedState.replaySlots)
        return (
          ...
          (onAllReady = createPendingSegment(renderState, 0, null, postponedState.rootFormatContext, !1, !1)),
    ...
    function encodeErrorForBoundary(boundary, digest, error, thrownInfo, wasAborted) {
      ...
      : ((digest = "object" === typeof error && null !== error ? describeObjectForErrorMessage(error) : String(error)),
        (error = null))
      wasAborted =
        wasAborted ?
    ...
    function finishFunctionComponent(
      ...
      : didEmitActionStateMarkers ? renderNode(request, task, children, -1)
      ...
      if ("function" === typeof type)
        if (type.prototype && type.prototype.isReactComponent) {
          ...
          if (
            ...
            var addendum =
              ...
              : "object" !== typeof contextType ? " However, it is set to a " + typeof contextType + "."
          ...
          if (
            ...
            if (
              ...
              : "function" === typeof context.UNSAFE_componentWillMount && (contextType = "UNSAFE_componentWillMount"),
              (
                "function" === typeof context.componentWillReceiveProps &&
                !0 !== context.componentWillReceiveProps.__suppressDeprecationWarning
              ) ?
              ...
              : "function" === typeof context.UNSAFE_componentWillUpdate && (ref = "UNSAFE_componentWillUpdate"),
          ...
          ;(addendum = context.state) &&
            ...
            console.error("%s.state: must be set to an object or null", contextType)
          ...
          context.context = "object" === typeof ref && null !== ref ? ref._currentValue2 : emptyContextObject
          context.state === props &&
          ...
          "function" === typeof ref &&
            ...
            (addendum = null === ref || void 0 === ref ? addendum : assign({}, addendum, ref)),
            (context.state = addendum))
          if (
            "function" !== typeof type.getDerivedStateFromProps &&
            "function" !== typeof context.getSnapshotBeforeUpdate &&
            ...
            if (
              ...
              if (
                ...
                ref = !0
                for (_componentName = _componentName ? 1 : 0; _componentName < addendum.length; _componentName++)
                  (newApiName = addendum[_componentName]),
                    ...
                    null != newApiName &&
                      (ref ?
                        ((ref = !1), (contextType = assign({}, contextType, newApiName)))
          ...
          "function" === typeof type.getDerivedStateFromProps &&
            ...
            didWarnAboutGetDerivedStateOnFunctionComponent[ref] ||
              (console.error("%s: Function components do not support getDerivedStateFromProps.", ref),
          ...
          "object" === typeof type.contextType &&
            ...
            didWarnAboutContextTypeOnFunctionComponent[type] ||
              (console.error("%s: Function components do not support contextType.", type),
              (didWarnAboutContextTypeOnFunctionComponent[type] = !0)))
          finishFunctionComponent(request, task, keyPath, props, context, contextType, addendum)
        }
        ...
        (context = task.blockedSegment),
          ...
          : ((contextType = pushStartInstance(
            ...
            (ref = task.keyPath),
            (task.formatContext = getChildFormatContext(addendum, type, props)),
            (task.keyPath = keyPath),
            renderNode(request, task, contextType, -1),
            (task.formatContext = addendum),
            (task.keyPath = ref),
            pushEndInstance(context.chunks, type, props, request.resumableState, addendum),
            (context.lastPushedText = !1))
      else {
        switch (type) {
          ...
          case REACT_SUSPENSE_TYPE:
            a: if (null !== task.replay) {
              ...
              null !== request.trackedPostpones && (newApiName.trackedContentKeyPath = keyPath)
              ...
              if (null !== request.trackedPostpones) {
                ...
                try {
                  ...
                  ;(newApiName.status = 4),
                    12 === request.status ?
                      ((contentRootSegment.status = 3), (context = request.fatalError))
                    : ((contentRootSegment.status = 4), (context = thrownValue$2)),
                    (contextType = getThrownInfo(task.componentStack)),
                    (addendum = logRecoverableError(request, context, contextType)),
                    encodeErrorForBoundary(newApiName, addendum, context, contextType, !1),
            ...
            case REACT_FORWARD_REF_TYPE:
              if ("ref" in props)
                for (_componentName in ((context = {}), props))
                  "ref" !== _componentName && (context[_componentName] = props[_componentName])
              else context = props
              type = renderWithHooks(request, task, keyPath, type.render, context, ref)
      ...
      if (null !== node) {
        if ("object" === typeof node) {
          ...
          null === node || "object" !== typeof node ?
            (props = null)
          : ((childNodes = (MAYBE_ITERATOR_SYMBOL && node[MAYBE_ITERATOR_SYMBOL]) || node["@@iterator"]),
          ...
          if (props && (childNodes = props.call(node))) {
            if (childNodes === node) {
              if (
                ...
                "[object GeneratorFunction]" !== Object.prototype.toString.call(task.componentStack.type) ||
        ...
        : ("function" === typeof node &&
          ...
          "symbol" === typeof node && console.error("Symbols are not valid as a React child.\n  %s", String(node)))
      }
    }
    function renderChildrenArray(request$jscomp$0, task, children, childIndex) {
      ...
      if (null !== task.replay && ((j = task.replay.slots), null !== j && "object" === typeof j)) {
        for (childIndex = 0; childIndex < replayNodes; childIndex++) {
          ...
          "number" === typeof resumeSegmentID ?
            (resumeNode(request$jscomp$0, task, resumeSegmentID, node, childIndex), delete j[childIndex])
      ...
      for (j = 0; j < replayNodes; j++) {
        ...
        if (
          ...
          (resumeSegmentID.$$typeof === REACT_ELEMENT_TYPE || resumeSegmentID.$$typeof === REACT_PORTAL_TYPE) &&
          resumeSegmentID._store &&
          ((!resumeSegmentID._store.validated && null == resumeSegmentID.key) || 2 === resumeSegmentID._store.validated)
        ) {
    ...
    function abortRemainingReplayNodes(
      ...
      if (null !== slots) {
        ...
        4 !== boundary.status &&
          ((boundary.status = 4),
          encodeErrorForBoundary(boundary, errorDigest$jscomp$0, error$jscomp$0, errorInfo$jscomp$0, aborted),
      ...
      if (null === boundary) {
        if (13 !== request.status && 14 !== request.status) {
          ...
          0 === boundary.pendingTasks &&
            ...
            abortRemainingReplayNodes(request, null, boundary.nodes, boundary.slots, error, task, segment, !0))
            ...
            if (null === segment) {
              ...
              if (0 !== request.replay.pendingTasks) {
                ...
                try {
                  "number" === typeof request.replay.slots ?
                    resumeNode(request$jscomp$0, request, request.replay.slots, request.node, request.childIndex)
              ...
              if (0 === segment$jscomp$0.status) {
                ...
                try {
                  ...
                  var x$jscomp$0 =
                    thrownValue === SuspenseException ? getSuspendedThenable()
                    : 12 === request.status ? request.fatalError
                    : thrownValue
                  if ("object" === typeof x$jscomp$0 && null !== x$jscomp$0 && "function" === typeof x$jscomp$0.then) {
                    ...
                    : (boundary.pendingTasks--,
                      4 !== boundary.status &&
                        ((boundary.status = 4),
                        encodeErrorForBoundary(boundary, prevTaskInDEV, x$jscomp$0, errorInfo$jscomp$0, !1),
                        untrackBoundary(request, boundary),
                        boundary.parentFlushed && request.clientRenderedBoundaries.push(boundary)))
                    request.allPendingTasks--
                    0 === request.allPendingTasks && completeAll(request)
    ...
    var pushSegmentFinale = $$$config.pushSegmentFinale,
      ...
      pushFormStateMarkerIsNotMatching = $$$config.pushFormStateMarkerIsNotMatching,
      ...
      writeStartPendingSuspenseBoundary = $$$config.writeStartPendingSuspenseBoundary,
      writeStartClientRenderedSuspenseBoundary = $$$config.writeStartClientRenderedSuspenseBoundary,
      writeEndCompletedSuspenseBoundary = $$$config.writeEndCompletedSuspenseBoundary,
      writeEndPendingSuspenseBoundary = $$$config.writeEndPendingSuspenseBoundary,
      writeEndClientRenderedSuspenseBoundary = $$$config.writeEndClientRenderedSuspenseBoundary,
      writeStartSegment = $$$config.writeStartSegment,
      writeEndSegment = $$$config.writeEndSegment,
      writeCompletedSegmentInstruction = $$$config.writeCompletedSegmentInstruction,
      writeCompletedBoundaryInstruction = $$$config.writeCompletedBoundaryInstruction,
      writeClientRenderBoundaryInstruction = $$$config.writeClientRenderBoundaryInstruction,
    ...
    var classComponentUpdater = {
        ...
        enqueueSetState: function (inst, payload, callback) {
          ...
          : (internals.queue.push(payload), void 0 !== callback && null !== callback && warnOnInvalidCallback(callback))
        },
      ...
      HooksDispatcher = {
        ...
        useId: function () {
          ...
          context = context.id
          treeId = (context & ~(1 << (32 - clz32(context) - 1))).toString(32) + treeId
    ...
    exports.prepareForStartFlowingIfBeforeAllReady = function (request) {
      safelyEmitEarlyPreloads(
        request,
        null === request.trackedPostpones ? 0 === request.pendingRootTasks
        : null === request.completedRootSegment ? 0 === request.pendingRootTasks
