  ...
  function resolveClassComponentProps(Component, baseProps) {
    ...
    if ((Component = Component.defaultProps)) {
      ...
      for (var propName$16 in Component)
        void 0 === newProps[propName$16] && (newProps[propName$16] = Component[propName$16])
    }
    return newProps
  }
  ...
  function renderElement(request, task, keyPath, type, props, ref) {
    if ("function" === typeof type)
      if (type.prototype && type.prototype.isReactComponent) {
        ...
        var initialState = void 0 !== JSCompiler_inline_result.state ? JSCompiler_inline_result.state : null
        ...
        if (
          ...
          "function" !== typeof JSCompiler_inline_result.getSnapshotBeforeUpdate &&
          ("function" === typeof JSCompiler_inline_result.UNSAFE_componentWillMount ||
          ...
          if (
            ...
            type !== JSCompiler_inline_result.state &&
              classComponentUpdater.enqueueReplaceState(JSCompiler_inline_result, JSCompiler_inline_result.state, null),
              ...
              for (ref = ref ? 1 : 0; ref < type.length; ref++) {
                ...
                partial =
                  "function" === typeof partial ?
                    partial.call(JSCompiler_inline_result, contextType, props, void 0)
                  : partial
                null != partial &&
                  (initialState ?
                    ((initialState = !1), (contextType = assign({}, contextType, partial)))
      ...
      (JSCompiler_inline_result = task.blockedSegment),
        ...
        : ((contextType = pushStartInstance(
          ...
          (ref = task.keyPath),
          (task.formatContext = getChildFormatContext(initialState, type, props)),
          (task.keyPath = keyPath),
          renderNode(request, task, contextType, -1),
          (task.formatContext = initialState),
          (task.keyPath = ref),
          pushEndInstance(JSCompiler_inline_result.chunks, type, props, request.resumableState, initialState),
          (JSCompiler_inline_result.lastPushedText = !1))
    else {
      switch (type) {
        ...
        case REACT_SUSPENSE_TYPE:
          a: if (null !== task.replay) {
            ...
            if (null !== request.trackedPostpones) {
              JSCompiler_inline_result = [keyPath[0], "Suspense Fallback", keyPath[2]]
              contextType = [JSCompiler_inline_result[1], JSCompiler_inline_result[2], [], null]
              request.trackedPostpones.workingMap.set(JSCompiler_inline_result, contextType)
              ...
              try {
                ...
                ;(newBoundary.status = 4),
                  12 === request.status ?
                    ((contentRootSegment.status = 3), (JSCompiler_inline_result = request.fatalError))
                  : ((contentRootSegment.status = 4), (JSCompiler_inline_result = thrownValue$11)),
                  (contextType = getThrownInfo(task.componentStack)),
                  (initialState = logRecoverableError(request, JSCompiler_inline_result, contextType)),
          ...
          case REACT_FORWARD_REF_TYPE:
            if ("ref" in props)
              for (partial in ((JSCompiler_inline_result = {}), props))
                "ref" !== partial && (JSCompiler_inline_result[partial] = props[partial])
            else JSCompiler_inline_result = props
            type = renderWithHooks(request, task, keyPath, type.render, JSCompiler_inline_result, ref)
            finishFunctionComponent(
              request,
              task,
              keyPath,
    ...
    if (null === segment)
      ...
      try {
        ...
        if (
          ...
          (node = thrownValue$31 === SuspenseException ? getSuspendedThenable() : thrownValue$31),
          "object" === typeof node && null !== node)
        ) {
          if ("function" === typeof node.then) {
            childIndex = getThenableStateAfterSuspending()
  ...
  var pushSegmentFinale = $$$config.pushSegmentFinale,
    ...
    HooksDispatcher = {
      ...
      useId: function () {
        ...
        context = context.id
        JSCompiler_inline_result = (context & ~(1 << (32 - clz32(context) - 1))).toString(32) + JSCompiler_inline_result
