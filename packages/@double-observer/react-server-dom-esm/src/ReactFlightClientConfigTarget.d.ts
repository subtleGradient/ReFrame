...
export declare function resolveServerReference<T>(config: ServerManifest, id: ServerReferenceId): ClientReference<T>

export declare function preloadModule<T>(metadata: ClientReference<T>): null | Thenable<any>
