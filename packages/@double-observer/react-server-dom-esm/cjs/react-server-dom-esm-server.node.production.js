...
function preconnect(href, crossOrigin) {
  if ("string" === typeof href) {
    ...
    if (request) {
      ...
      hints.has(key) ||
        (hints.add(key),
        "string" === typeof crossOrigin ? emitHint(request, "C", [href, crossOrigin]) : emitHint(request, "C", href))
...
var DefaultAsyncDispatcher = {
    getCacheForType: function (resourceType) {
      var JSCompiler_inline_result =
        (JSCompiler_inline_result = resolveRequest()) ? JSCompiler_inline_result.cache : new Map()
...
function describeObjectForErrorMessage(objectOrArray, expandedName) {
  ...
  if (isArrayImpl(objectOrArray)) {
    ...
    for (var i = 0; i < objectOrArray.length; i++) {
      ...
      : (str = 10 > value.length && 40 > str.length + value.length ? str + value : str + "...")
    }
    str += "]"
    ...
    for (value = 0; value < i.length; value++) {
      ...
      name === expandedName ?
        ((objKind = str.length), (length = encodedKey.length), (str += encodedKey))
      : (str = 10 > encodedKey.length && 40 > str.length + encodedKey.length ? str + encodedKey : str + "...")
    }
    str += "}"
  }
  return (
    void 0 === expandedName ? str
    : -1 < objKind && 0 < length ?
...
function serializeReadableStream(request, task, stream) {
  ...
  var reader = stream.getReader(),
    streamTask = createTask(request, task.model, task.keyPath, task.implicitSlot, request.abortableTasks)
...
function renderFunctionComponent(request, task, key, Component, props) {
  ...
  if ("object" === typeof Component && null !== Component && Component.$$typeof !== CLIENT_REFERENCE_TAG$1) {
    ...
    if (iteratorFn) {
      ...
      !(
        ...
        ("function" === typeof ReadableStream && Component instanceof ReadableStream)
      )
    ) {
  ...
  null !== key ? (task.keyPath = null === props ? key : props + "," + key) : null === props && (task.implicitSlot = !0)
...
function renderFragment(request, task, children) {
  return null !== task.keyPath ?
      ((request = [REACT_ELEMENT_TYPE, REACT_FRAGMENT_TYPE, task.keyPath, { children: children }]),
      ...
      try {
        ...
        if (
          ...
          (parentPropertyName =
            ...
            (parentPropertyName.$$typeof === REACT_ELEMENT_TYPE || parentPropertyName.$$typeof === REACT_LAZY_TYPE)),
          12 === request.status)
        )
          (task.status = 3),
            (prevKeyPath = request.fatalError),
            (JSCompiler_inline_result =
              parentPropertyName ? "$L" + prevKeyPath.toString(16) : serializeByValueID(prevKeyPath))
        else if (
          ((value = thrownValue === SuspenseException ? getSuspendedThenable() : thrownValue),
          "object" === typeof value && null !== value && "function" === typeof value.then)
        ) {
...
function renderModelDestructive(request, task, parent, parentPropertyName, value) {
  ...
  if ("object" === typeof value) {
    switch (value.$$typeof) {
      case REACT_ELEMENT_TYPE:
        ...
        if (null === task.keyPath && !task.implicitSlot) {
          ...
          if (void 0 !== existingReference)
            ...
            -1 === parentPropertyName.indexOf(":") &&
              ...
              void 0 !== parent &&
                ((elementReference = parent + ":" + parentPropertyName), writtenObjects.set(value, elementReference)))
        }
        ...
        "object" === typeof request &&
          ...
          (writtenObjects.has(request) || writtenObjects.set(request, elementReference))
        return request
      case REACT_LAZY_TYPE:
        task.thenableState = null
    ...
    if (void 0 !== writtenObjects)
      ...
      -1 === parentPropertyName.indexOf(":") &&
      ((writtenObjects = elementReference.get(parent)), void 0 !== writtenObjects)
    ) {
    ...
    if ((elementReference = getIteratorFn(value)))
      return (
        ...
        parentPropertyName === value ?
          "$i" + outlineModel(request, Array.from(parentPropertyName)).toString(16)
    ...
    if ("function" === typeof elementReference)
      return (
        null !== task.keyPath ?
          ((request = [REACT_ELEMENT_TYPE, REACT_FRAGMENT_TYPE, task.keyPath, { children: value }]),
          (request = task.implicitSlot ? [request] : request))
        : ((parentPropertyName = elementReference.call(value)),
          (request = serializeAsyncIterable(request, task, value, parentPropertyName))),
        request
      )
    ...
    if (value.$$typeof === SERVER_REFERENCE_TAG)
      return (
        ...
        : ((parentPropertyName = value.$$bound),
          (parentPropertyName = null === parentPropertyName ? null : Promise.resolve(parentPropertyName)),
...
function flushCompletedChunks(request, destination) {
  ...
  0 === request.pendingChunks && ((request.status = 14), destination.end(), (request.destination = null))
}
  ...
  if ("object" === typeof value && null !== value)
    if (
      ...
      for (var i = 0; i < value.length; i++)
        value[i] = reviveModel(response, value, "" + i, value[i], void 0 !== reference ? reference + ":" + i : void 0)
    else
      for (i in value)
...
exports.decodeFormState = function (actionResult, body, serverManifest) {
  ...
  body.forEach(function (value, key) {
    key.startsWith("$ACTION_REF_") &&
      ((value = "$ACTION_" + key.slice(12) + ":"), (metaData = decodeBoundActionMetaData(body, serverManifest, value)))
  })
...
exports.decodeReplyFromBusboy = function (busboyStream, moduleBasePath, options) {
  ...
  busboyStream.on("file", function (name, value, _ref) {
    ...
    pendingFiles++
    var JSCompiler_object_inline_chunks_217 = []
    value.on("data", function (chunk) {
      JSCompiler_object_inline_chunks_217.push(chunk)
    })
    value.on("end", function () {
      var blob = new Blob(JSCompiler_object_inline_chunks_217, {
        type: mimeType,
      })
