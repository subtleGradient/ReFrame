  ...
  (function () {
    ...
    function registerServerReference(proxy, reference$jscomp$0, encodeFormAction) {
      Object.defineProperties(proxy, {
        $$FORM_ACTION: {
          value:
            void 0 === encodeFormAction ? defaultEncodeFormAction : (
              function () {
                var reference = knownServerReferences.get(this)
                if (!reference)
                  throw Error(
    ...
    function resolveModule(response, id, model) {
      ...
      prepareDestinationForModuleImpl(response._moduleLoading, model[0], response._nonce)
        ...
        iterable = _defineProperty({}, ASYNC_ITERATOR, function () {
          ...
          return createIterator(function (arg) {
            ...
            if (nextReadIndex === buffer.length) {
              if (closed) return new ReactPromise("fulfilled", { done: !0, value: void 0 }, null, response)
      ...
      resolveStream(response, id, iterator ? iterable[ASYNC_ITERATOR]() : iterable, {
        enqueueValue: function (value) {
          if (nextWriteIndex === buffer.length)
            buffer[nextWriteIndex] = new ReactPromise("fulfilled", { done: !1, value: value }, null, response)
          else {
      ...
      switch (code) {
        ...
        case "S":
          "string" === typeof response ?
            model.S(response)
          : model.S(response[0], 0 === response[1] ? void 0 : response[1], 3 === response.length ? response[2] : void 0)
          break
        case "M":
          "string" === typeof response ? model.M(response) : model.M(response[0], response[1])
      }
    ...
    function resolveTypedArray(response, id, buffer, lastChunk, constructor, bytesPerElement) {
      buffer =
        0 === buffer.length && 0 === lastChunk.byteOffset % bytesPerElement ? lastChunk : mergeBuffer(buffer, lastChunk)
          ...
          try {
            a: {
              ...
              switch (methodName) {
                ...
                case "groupEnd":
                case "table":
                  var JSCompiler_inline_result = bind$1.apply(console[methodName], [console].concat(args))
                  break a
                case "assert":
                  offset = 1
              }
