...
function ResponseInstance(
...

  {
    ...
    var rootOwner =
      ReactSharedInteralsServer === undefined || ReactSharedInteralsServer.A === null ?
        null
      : ReactSharedInteralsServer.A.getOwner()
    this._debugRootOwner = rootOwner
    this._debugRootStack =
      (
        rootOwner !== null // TODO: Consider passing the top frame in so we can avoid internals showing up.
      ) ?
...
function resolveErrorDev(response, errorInfo) {
...

  {
    var callStack = buildFakeCallStack(
      response,
      stack,
      env, // $FlowFixMe[incompatible-use]
...
var createFakeJSXCallStackInDEV = createFakeJSXCallStack["react-stack-bottom-frame"].bind(createFakeJSXCallStack) // We use this technique to trick minifiers to preserve the function name.
/** @noinline */
...
function createResponseFromOptions(options) {
  return createResponse(
    ...
    options ? options.replayConsoleLogs !== false : true, // defaults to true
