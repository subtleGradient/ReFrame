  ...
  (function () {
      ...
      if ("string" === typeof chunk) {
        if (0 !== chunk.length)
          if (2048 < 3 * chunk.length)
            ...
            2048 === writtenBytes &&
              (writeToDestination(destination, currentView), (currentView = new Uint8Array(2048)), (writtenBytes = 0))
          }
      } else
        0 !== chunk.byteLength &&
    ...
    function describeValueForErrorMessage(value) {
      switch (typeof value) {
        ...
        case "function":
          return (
            value.$$typeof === CLIENT_REFERENCE_TAG ? "client"
            : (value = value.displayName || value.name) ? "function " + value
            : "function"
          )
        default:
          return String(value)
      ...
      if (isArrayImpl(objectOrArray))
        if (jsxChildrenParents.has(objectOrArray)) {
          ...
          for (var i = 0; i < objectOrArray.length; i++) {
            ...
            value =
              ...
              : "object" === typeof value && null !== value ? "{" + describeObjectForErrorMessage(value) + "}"
              : "{" + describeValueForErrorMessage(value) + "}"
            "" + i === expandedName ?
              ((start = objKind.length), (length = value.length), (objKind += value))
            : (objKind = 15 > value.length && 40 > objKind.length + value.length ? objKind + value : objKind + "{...}")
          }
          objKind += "</" + describeElementType(type) + ">"
        } else {
          objKind = "["
        ...
        if (jsxPropsParents.has(objectOrArray)) {
          ...
          for (i = 0; i < type.length; i++) {
            ...
            : (objKind =
                10 > _substr2.length && 40 > objKind.length + _substr2.length ? objKind + _substr2 : objKind + "...")
          }
          objKind += ">"
        } else {
          objKind = "{"
          ...
          for (i = 0; i < type.length; i++)
            0 < i && (objKind += ", "),
              ...
              : (objKind =
                  10 > _value2.length && 40 > objKind.length + _value2.length ? objKind + _value2 : objKind + "...")
          objKind += "}"
        }
      }
      return (
        void 0 === expandedName ? objKind
        : -1 < start && 0 < length ?
    ...
    function renderFunctionComponent(request, task, key, Component, props) {
      ...
      props = componentStorage.run(componentDebugInfo, callComponentInDEV, Component, props, componentDebugInfo)
      if (request.status === ABORTING)
        throw (
          ("object" !== typeof props ||
            null === props ||
        ...
        if (iteratorFn) {
          ...
          props = _defineProperty({}, Symbol.iterator, function () {
            ...
            iterator !== iterableChild ||
              ("[object GeneratorFunction]" === Object.prototype.toString.call(Component) &&
                "[object Generator]" === Object.prototype.toString.call(iterableChild)) ||
          ...
          ("function" === typeof ReadableStream && props instanceof ReadableStream)
        )
          ...
          props = _defineProperty({}, ASYNC_ITERATOR, function () {
            ...
            iterator !== _iterableChild ||
              ("[object AsyncGeneratorFunction]" === Object.prototype.toString.call(Component) &&
                "[object AsyncGenerator]" === Object.prototype.toString.call(_iterableChild)) ||
              callWithDebugContextInDEV(request, task, function () {
                console.error(
      ...
      null !== key ?
        (task.keyPath = null === prevThenableState ? key : prevThenableState + "," + key)
    ...
    function renderFragment(request, task, children) {
      ...
      if (null !== task.keyPath)
        return (
          (request = [REACT_ELEMENT_TYPE, REACT_FRAGMENT_TYPE, task.keyPath, { children: children }, null]),
      ...
      if ("function" !== typeof type || isClientReference(type) || type.$$typeof === TEMPORARY_REFERENCE_TAG) {
        if (type === REACT_FRAGMENT_TYPE && null === key)
          return (
            ...
            (request = renderModelDestructive(request, task, emptyRoot, "", props.children)),
    ...
    function serializeClientReference(request, parent, parentPropertyName, clientReference) {
      ...
      try {
        ...
        if (!fullURL.startsWith(baseURL)) throw Error("Attempted to load a Client Module outside the hosted root.")
        var clientReferenceMetadata = [fullURL.slice(baseURL.length), exportName]
        request.pendingChunks++
    ...
    function serializeBlob(request, blob) {
      ...
      var model = [blob.type],
        newTask = createTask(request, model, null, !1, request.abortableTasks, null),
    ...
    function renderModel(request, task, parent, key, value) {
      ...
      try {
        ...
        parent =
          ...
          null !== parent &&
          (parent.$$typeof === REACT_ELEMENT_TYPE || parent.$$typeof === REACT_LAZY_TYPE)
        if (request.status === ABORTING)
          return (
            (task.status = ABORTED),
        ...
        if ("object" === typeof key && null !== key && "function" === typeof key.then)
          return (
            ...
            parent ? "$L" + request.id.toString(16) : serializeByValueID(request.id)
          )
        task.keyPath = prevKeyPath
        task.implicitSlot = prevImplicitSlot
        request.pendingChunks++
    ...
    function renderModelDestructive(request, task, parent, parentPropertyName, value) {
      ...
      if ("object" === typeof value) {
        switch (value.$$typeof) {
          case REACT_ELEMENT_TYPE:
              ...
              if (void 0 !== _existingReference)
                ...
                -1 === parentPropertyName.indexOf(":") &&
                  ...
                  void 0 !== _existingReference &&
                    ((elementReference = _existingReference + ":" + parentPropertyName),
            ...
            "object" === typeof request &&
              ...
              (_writtenObjects.has(request) || _writtenObjects.set(request, elementReference))
            return request
          case REACT_LAZY_TYPE:
            task.thenableState = null
        ...
        if (
          ...
          ((elementReference = request.temporaryReferences.get(value)), void 0 !== elementReference)
        )
        ...
        if (void 0 !== _writtenObjects)
          ...
          -1 === parentPropertyName.indexOf(":") &&
          ((_writtenObjects = elementReference.get(parent)), void 0 !== _writtenObjects)
        ) {
        ...
        if ((elementReference = getIteratorFn(value)))
          return (
            ...
            elementReference === value ?
              "$i" + outlineModel(request, Array.from(elementReference)).toString(16)
        ...
        if (
          ...
          (null === elementReference || null !== getPrototypeOf(elementReference))
        )
          throw Error(
      ...
      if ("string" === typeof value)
        return (
          "Z" === value[value.length - 1] && parent[parentPropertyName] instanceof Date ? "$D" + value
          : 1024 <= value.length && null !== byteLengthOfChunk ? serializeLargeTextString(request, value)
          : "$" === value[0] ? "$" + value
          : value
        )
    ...
    function logRecoverableError(request, error, task) {
      ...
      try {
        ...
        var errorDigest =
          null !== task ?
            requestStorage.run(void 0, callWithDebugContextInDEV, request, task, onError, error)
    ...
    function emitErrorChunk(request, id, digest, error) {
      ...
      try {
        if (error instanceof Error) {
          ...
          (message =
            "object" === typeof error && null !== error ? describeObjectForErrorMessage(error) : String(error)),
            (stack = [])
      } catch (x) {
        ;(message = "An error occurred but serializing the error message failed."), (stack = [])
      }
    ...
    function renderConsoleValue(request, counter, parent, parentPropertyName, value) {
      ...
      if ("object" === typeof value) {
        ...
        switch (value.$$typeof) {
          case REACT_ELEMENT_TYPE:
            return (
              ...
              [REACT_ELEMENT_TYPE, value.type, value.key, value.props, value._owner]
            )
        }
        if ("function" === typeof value.then) {
          switch (value.status) {
        ...
        return (
          "function" === typeof FormData && value instanceof FormData ? serializeFormData(request, value)
          : value instanceof Error ? serializeErrorValue(request, value)
          : value instanceof ArrayBuffer ? serializeTypedArray(request, "A", new Uint8Array(value))
          : value instanceof Int8Array ? serializeTypedArray(request, "O", value)
          : value instanceof Uint8Array ? serializeTypedArray(request, "o", value)
          : value instanceof Uint8ClampedArray ? serializeTypedArray(request, "U", value)
          : value instanceof Int16Array ? serializeTypedArray(request, "S", value)
          : value instanceof Uint16Array ? serializeTypedArray(request, "s", value)
          : value instanceof Int32Array ? serializeTypedArray(request, "L", value)
          : value instanceof Uint32Array ? serializeTypedArray(request, "l", value)
          : value instanceof Float32Array ? serializeTypedArray(request, "G", value)
          : value instanceof Float64Array ? serializeTypedArray(request, "g", value)
          : value instanceof BigInt64Array ? serializeTypedArray(request, "M", value)
          : value instanceof BigUint64Array ? serializeTypedArray(request, "m", value)
          : value instanceof DataView ? serializeTypedArray(request, "V", value)
          : "function" === typeof Blob && value instanceof Blob ? serializeBlob(request, value)
          : getIteratorFn(value) ? Array.from(value)
          : value
        )
      }
      if ("string" === typeof value)
        return (
          "Z" === value[value.length - 1] && parent[parentPropertyName] instanceof Date ? "$D" + value
          : 1024 <= value.length ? serializeLargeTextString(request, value)
          : "$" === value[0] ? "$" + value
          : value
        )
      if ("boolean" === typeof value) return value
      ...
      if ("function" === typeof value)
        return (
          isClientReference(value) ? serializeClientReference(request, parent, parentPropertyName, value)
          : (
            void 0 !== request.temporaryReferences &&
            ((request = request.temporaryReferences.get(value)), void 0 !== request)
          ) ?
      ...
      return (
        "bigint" === typeof value ? "$n" + value.toString(10)
        : value instanceof Date ? "$D" + value.toJSON()
    ...
    function emitConsoleChunk(request, methodName, owner, stackTrace, args) {
      ...
      try {
        ...
        json = stringify(
          [methodName, stackTrace, owner, env, "Unknown Value: React could not send it from the server.", x],
          replacer,
        )
      }
    ...
    function forwardDebugInfo(request, id, debugInfo) {
      for (var i = 0; i < debugInfo.length; i++)
        request.pendingChunks++,
          "string" === typeof debugInfo[i].name && outlineComponentInfo(request, debugInfo[i]),
          emitDebugChunk(request, id, debugInfo[i])
    }
    function emitChunk(request, task, value) {
      var id = task.id
      "string" === typeof value && null !== byteLengthOfChunk ? emitTextChunk(request, id, value)
      : value instanceof ArrayBuffer ? emitTypedArrayChunk(request, id, "A", new Uint8Array(value))
      : value instanceof Int8Array ? emitTypedArrayChunk(request, id, "O", value)
      : value instanceof Uint8Array ? emitTypedArrayChunk(request, id, "o", value)
      : value instanceof Uint8ClampedArray ? emitTypedArrayChunk(request, id, "U", value)
      : value instanceof Int16Array ? emitTypedArrayChunk(request, id, "S", value)
      : value instanceof Uint16Array ? emitTypedArrayChunk(request, id, "s", value)
      : value instanceof Int32Array ? emitTypedArrayChunk(request, id, "L", value)
      : value instanceof Uint32Array ? emitTypedArrayChunk(request, id, "l", value)
      : value instanceof Float32Array ? emitTypedArrayChunk(request, id, "G", value)
      : value instanceof Float64Array ? emitTypedArrayChunk(request, id, "g", value)
      : value instanceof BigInt64Array ? emitTypedArrayChunk(request, id, "M", value)
      : value instanceof BigUint64Array ? emitTypedArrayChunk(request, id, "m", value)
      : value instanceof DataView ? emitTypedArrayChunk(request, id, "V", value)
        ...
        try {
          ...
          if ("object" === typeof resolvedModel && null !== resolvedModel) {
            ...
            currentEnv !== task.environmentName &&
              (request.pendingChunks++, emitDebugChunk(request, task.id, { env: currentEnv }))
            emitChunk(request, task, resolvedModel)
          } else {
            var json = stringify(resolvedModel),
              _currentEnv = (0, request.environmentName)()
            _currentEnv !== task.environmentName &&
              (request.pendingChunks++, emitDebugChunk(request, task.id, { env: _currentEnv }))
    ...
    function flushCompletedChunks(request, destination) {
      ...
      0 === request.pendingChunks && ((request.status = CLOSED), destination.end(), (request.destination = null))
    }
    ...
    function startFlowing(request, destination) {
      if (request.status === CLOSING) (request.status = CLOSED), destination.destroy(request.fatalError)
    ...
    function abort(request, reason) {
      try {
        ...
        if (0 < abortableTasks.size) {
          var error =
              void 0 === reason ? Error("The render was aborted by the server without a reason.")
    ...
    function resolveServerReference(config, id) {
      var idx = id.lastIndexOf("#"),
        exportName = id.slice(idx + 1)
      id = id.slice(0, idx)
      if (!id.startsWith(config)) throw Error("Attempted to load a Server Reference outside the hosted root.")
      return { specifier: id, name: exportName }
    }
    function preloadModule(metadata) {
      var existingPromise = asyncModuleCache.get(metadata.specifier)
      if (existingPromise) return "fulfilled" === existingPromise.status ? null : existingPromise
    ...
    function resolveModelChunk(chunk, value, id) {
      if ("pending" !== chunk.status)
        (chunk = chunk.reason),
          "C" === value[0] ? chunk.close("C" === value ? '"$undefined"' : value.slice(1)) : chunk.enqueueModel(value)
      else {
        ...
        if (null !== resolveListeners)
          switch ((initializeModelChunk(chunk), chunk.status)) {
            ...
            case "cyclic":
              if (chunk.value)
                for (value = 0; value < resolveListeners.length; value++) chunk.value.push(resolveListeners[value])
              else chunk.value = resolveListeners
              if (chunk.reason) {
                if (rejectListeners)
                  for (value = 0; value < rejectListeners.length; value++) chunk.reason.push(rejectListeners[value])
    ...
    function loadServerReference$1(response, id, bound, parentChunk, parentObject, key) {
      ...
      bound.then(
        createModelResolver(parentChunk, parentObject, key, !1, response, createModel, []),
        ...
        if (
          ...
          for (i in value)
            hasOwnProperty.call(value, i) &&
              ((parentObj = void 0 !== reference && -1 === i.indexOf(":") ? reference + ":" + i : void 0),
    ...
    function getOutlinedModel(response, reference, parentObject, key, map) {
      ...
      switch (id.status) {
        ...
        case "cyclic":
          ...
          id.then(
            createModelResolver(parentChunk, parentObject, key, "cyclic" === id.status, response, map, reference),
            createModelReject(parentChunk),
          )
          return null
        default:
    ...
    function parseTypedArray(response, reference, constructor, bytesPerElement, parentObject, parentKey) {
      ...
      reference.then(
        createModelResolver(bytesPerElement, parentObject, parentKey, !1, response, createModel, []),
        ...
        iterable = _defineProperty({}, ASYNC_ITERATOR, function () {
          ...
          return createIterator(function (arg) {
            ...
            if (nextReadIndex === buffer.length) {
              if (closed) return new Chunk("fulfilled", { done: !0, value: void 0 }, null, response)
        ...
        switch (value[1]) {
          ...
          case "F":
            return (
              ...
              loadServerReference$1(response, value.id, value.bound, initializingChunk, obj, key)
            )
          case "T":
    ...
    function createResponse(bundlerConfig, formFieldPrefix, temporaryReferences) {
      var backingFormData = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : new FormData(),
        chunks = new Map()
      return {
      ...
      S: function (href, precedence, options) {
        if ("string" === typeof href) {
          ...
          if (request) {
            ...
            return (
              (options = trimOptions(options)) ?
                emitHint(request, "S", [href, "string" === typeof precedence ? precedence : 0, options])
              : "string" === typeof precedence ? emitHint(request, "S", [href, precedence])
    ...
    var callComponent = {
      ...
      callIteratorInDEV = callIterator["react-stack-bottom-frame"].bind(callIterator),
      ...
      body.forEach(function (value, key) {
        key.startsWith("$ACTION_") ?
          ...
          : key.startsWith("$ACTION_ID_") &&
            ((value = key.slice(11)), (action = loadServerReference(serverManifest, value, null)))
    ...
    exports.decodeReply = function (body, moduleBasePath, options) {
      ...
      body = createResponse(moduleBasePath, "", options ? options.temporaryReferences : void 0, body)
      moduleBasePath = getChunk(body, 0)
      close(body)
      return moduleBasePath
    }
    exports.decodeReplyFromBusboy = function (busboyStream, moduleBasePath, options) {
      var response = createResponse(moduleBasePath, "", options ? options.temporaryReferences : void 0),
        pendingFiles = 0,
        queuedFields = []
      ...
      busboyStream.on("file", function (name, value, _ref) {
        ...
        pendingFiles++
        var JSCompiler_object_inline_chunks_142 = []
        value.on("data", function (chunk) {
          JSCompiler_object_inline_chunks_142.push(chunk)
        })
        value.on("end", function () {
          var blob = new Blob(JSCompiler_object_inline_chunks_142, {
            type: mimeType,
          })
