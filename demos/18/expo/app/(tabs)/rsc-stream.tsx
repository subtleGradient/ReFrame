...
import type { CallServerCallback, ServerCallbackMap } from "@double-observer/react-client/src/ReactFlightReplyClient"
// import { ReFrameClient, renderDynamicClientModule, Use } from "@subtlegradient/reframe/client"
import type { RSCSource } from "@subtlegradient/reframe/random/types"
  ...
  return (
    <ScrollView style={{ padding: 16, marginBottom: 32 }}>
      ...
      <Try catch={ErrorBoundary}>
        <Suspense fallback={<ThemedText>Loading...</ThemedText>}>{/* <Use>{reframe.from(fakeRSC)}</Use> */}</Suspense>
